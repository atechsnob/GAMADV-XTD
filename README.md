...
Installation - Upgrading from a GAM version other than a prior version of GAMADV-XTD
----------------------------------------------------------------------------------
Read GamConfig.txt.

## Linux/Mac OS

This example assumes that GAMADV-XTD has beem installed in /usr/local/gamadv-x.
