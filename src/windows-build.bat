...
"%ProgramFiles%\7-Zip\7z.exe" a -tzip gamadv-xtd-%1-windows.zip gam\ -xr!.svn
...
"%ProgramFiles%\7-Zip\7z.exe" a -tzip gamadv-xtd-%1-windows-x64.zip gam-64\ -xr!.svn

set GAMVERSION=%1
"%ProgramFiles(x86)%\WiX Toolset v3.10\bin\candle.exe" -arch x64 gam.wxs
"%ProgramFiles(x86)%\WiX Toolset v3.10\bin\light.exe" -ext "%ProgramFiles(x86)%\WiX Toolset v3.10\bin\WixUIExtension.dll" gam.wixobj -o gamadv-xtd-%1-windows-x64.msi
