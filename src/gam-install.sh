...
if [ "$gamversion" == "latest" -o "$gamversion" == "prerelease" -o "$gamversion" == "draft" ]; then
  release_url="https://api.github.com/repos/taers232c/GAMADV-XTD/releases"
else
  release_url="https://api.github.com/repos/taers232c/GAMADV-XTD/releases/tags/v$gamversion"
fi
